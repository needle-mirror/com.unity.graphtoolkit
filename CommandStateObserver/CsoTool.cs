...
namespace Unity.GraphToolkit.CSO
{
    ...
    /// </summary>
    [UnityRestricted]
    internal abstract class CsoTool : IDisposable, ICommandTarget
    {
        /// <summary>
        ...
        /// <summary>
        /// Registers all command handlers specific to the tool. Derived tools should implement this method to register their command handlers.
        /// </summary>
        /// <param name="registrar">The registrar can be used to help in registering commands handlers and binding them to state components.</param>
        ...
        /// <summary>
        /// Registers all observers specific to the tool. Derived tools should override this method to register their observers.
        /// </summary>
