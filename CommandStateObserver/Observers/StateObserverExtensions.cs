...
namespace Unity.GraphToolkit.CSO
{
    ...
    /// </summary>
    [UnityRestricted]
    internal static class StateObserverExtensions
    {
        /// <summary>
        ...
        {
            return Observation.Create(observer, stateComponent);
        }
        ...
        public static List<Observation> ObserveStates(this IStateObserver observer, IReadOnlyList<IStateComponent> stateComponents)
        {
            ...
            {
                observationList.Add(Observation.Create(observer, stateComponent));
            }
        ...
        {
            return Observation.Create(observer, stateComponent, false);
        }
    }
}
