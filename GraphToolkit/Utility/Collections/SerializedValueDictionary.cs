...
namespace Unity.GraphToolkit
{
    ...
    [Serializable]
    [MovedFrom(false, "Unity.GraphToolkit.CSO", "Unity.CommandStateObserver")]
    [UnityRestricted]
    internal class SerializedValueDictionary<TKey, TValue> : IDictionary<TKey, TValue>, IReadOnlyDictionary<TKey, TValue>, ISerializationCallbackReceiver
    {
        [SerializeField]
        List<TKey> m_KeyList;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SerializedValueDictionary{TKey, TValue}" /> class.
        /// </summary>
