...
namespace Unity.GraphToolkit.Editor
{
    ...
    [Serializable]
    [UnityRestricted]
    internal class DeclarationHighlighterStateComponent : StateComponent<DeclarationHighlighterStateComponent.StateUpdater>
    {
        /// <summary>
        /// The updater for the <see cref="DeclarationHighlighterStateComponent"/>.
        /// </summary>
        [UnityRestricted]
        internal class StateUpdater : BaseUpdater<DeclarationHighlighterStateComponent>
        {
            /// <summary>
