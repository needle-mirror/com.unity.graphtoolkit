...
namespace Unity.GraphToolkit.Editor
{
    ...
    /// </summary>
    [UnityRestricted]
    internal class BoolPref : Enumeration
    {
    ...
    /// </summary>
    [UnityRestricted]
    internal class IntPref : Enumeration
    {
        /// <summary>
    ...
    internal class Preferences
    {
        ...
        public Preferences(string editorPreferencesPrefix)
        {
            Transient = false;
        ...
        internal Preferences(string editorPreferencesPrefix, bool transient = false)
            : this(editorPreferencesPrefix)
        {
            Transient = transient;
        }
        ...
        public void Initialize<TBool, TInt, TString>()
