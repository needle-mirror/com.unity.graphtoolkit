...
namespace Unity.GraphToolkit.ItemLibrary.Editor
{
    ...
    /// </summary>
    [UnityRestricted]
    internal class ItemLibraryAdapter : IItemLibraryAdapter
    {
        /// <summary>
        ...
        /// <summary>
        /// Called once when the details panel gets initialized during the library view creation (<see cref="ItemLibraryControl"/>).
        /// </summary>
