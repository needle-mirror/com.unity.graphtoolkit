...
namespace Unity.GraphToolkit.ItemLibrary.Editor
{
    ...
    [Serializable]
    [UnityRestricted]
    internal abstract class ItemLibraryDatabaseBase
    {
        /// <summary>
        ...
        internal Dictionary<ItemLibraryItem, SearchData> LastSearchData { get; } = new Dictionary<ItemLibraryItem, SearchData>();
        ...
        /// <remarks>
        /// This method performs a search within the database and returns a list of <see cref="ItemLibraryItem"/>s that match the query. The query is typically a keyword,
        /// and the results depend on how the database is indexed.
        /// </remarks>
