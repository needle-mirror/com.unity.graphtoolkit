...
namespace Unity.GraphToolkit.Editor
{
    ...
    /// </summary>
    [UnityRestricted]
    internal class VirtualWire : IPortWireIndexModel
    {
        ...
        /// </summary>
        public PortModel FromPort => m_FromPortReference.GetPortModel(ref m_FromPortModelCache);

        /// <summary>
        /// The port to which the wire goes.
        /// </summary>
        public PortModel ToPort => m_ToPortReference.GetPortModel(ref m_ToPortModelCache);
