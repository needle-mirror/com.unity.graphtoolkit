    ...
    class GraphNodeLibraryAdapter : GraphElementLibraryAdapter
    {
        ...
        GraphView CreatePreviewGraphView()
        {
            ...
            if (graphview != null)
            {
                ...
                graphview.AddPackageStylesheet(k_USSPath);
        ...
        /// <inheritdoc />
        public override void SetHostGraphView(GraphView graphView,ItemLibrarySize size)
        {
            base.SetHostGraphView(graphView, size);
