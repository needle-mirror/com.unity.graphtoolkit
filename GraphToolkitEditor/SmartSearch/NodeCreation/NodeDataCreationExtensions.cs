...
namespace Unity.GraphToolkit.Editor
{
    ...
    /// </summary>
    [UnityRestricted]
    internal static class NodeDataCreationExtensions
    {
        /// <summary>
        ...
        public static AbstractNodeModel CreateVariableNode(this IGraphNodeCreationData data, VariableDeclarationModelBase declarationModel)
        {
        ...
        /// </summary>
        /// <param name="data">Data containing some of the required information to create a node.</param>
        /// <param name="subgraphModel">The subgraph model.</param>
