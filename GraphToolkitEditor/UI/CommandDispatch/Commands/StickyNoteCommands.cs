...
namespace Unity.GraphToolkit.Editor
{
    ...
    /// </summary>
    [UnityRestricted]
    internal class CreateStickyNoteCommand : UndoableCommand
    {
        /// <summary>
    ...
    /// </summary>
    [UnityRestricted]
    internal class UpdateStickyNoteCommand : UndoableCommand
    {
        /// <summary>
    ...
    /// </summary>
    [UnityRestricted]
    internal class UpdateStickyNoteThemeCommand : ModelCommand<StickyNoteModel, string>
    {
    ...
    /// </summary>
    [UnityRestricted]
    internal class UpdateStickyNoteTextSizeCommand : ModelCommand<StickyNoteModel, string>
    {
