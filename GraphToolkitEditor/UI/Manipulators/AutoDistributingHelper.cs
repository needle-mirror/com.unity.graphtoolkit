...
{
    class AutoDistributingHelper : AutoPlacementHelper
    {
        float m_DistributingMargin;
        PortOrientation m_Orientation;

        /// <summary>
        /// Initializes a new instance of the <see cref="AutoDistributingHelper"/> class.
        /// </summary>
        /// <param name="graphView">The <see cref="GraphView"/> in charge of distributing the elements.</param>
        public AutoDistributingHelper(GraphView graphView)
        {
