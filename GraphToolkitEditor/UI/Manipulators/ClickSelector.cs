...
namespace Unity.GraphToolkit.Editor
{
    ...
    /// </summary>
    [UnityRestricted]
    internal abstract class ClickSelector : MouseManipulator
    {
        ...
        public ClickSelector()
        {
            ...
            activators.Add(new ManipulatorActivationFilter { button = MouseButton.LeftMouse, modifiers = PlatformMultiSelectModifier });
        }

        /// <summary>
        /// The modifier used to select multiple elements on the current platform.
        /// </summary>
        public static EventModifiers PlatformMultiSelectModifier
        {
            get
            {
        ...
        /// <summary>
        /// Selects elements following a mouse event.
        /// </summary>
        /// <param name="e">The event that triggered this action.</param>
        protected abstract void DoSelect(IMouseEvent e);

        /// <summary>
        /// Displays elements in the inspector.
        /// </summary>
        /// <param name="e">The event that triggered this action.</param>
        protected abstract void DoInspect(IMouseEvent e);

        /// <summary>
        /// Selects elements following a mouse event and displays them in the inspector.
        /// </summary>
        /// <param name="e">The event that triggered this action.</param>
        protected abstract void DoSelectAndInspect(IMouseEvent e);
    }
}
