...
namespace Unity.GraphToolkit.Editor
{
    class SnapToSpacingStrategy : SnapStrategy
    {
        ...
        {
            SnapReference startReference = referenceRects.Orientation == PortOrientation.Vertical ? SnapReference.TopWire : SnapReference.LeftWire;
            SnapReference endReference = referenceRects.Orientation == PortOrientation.Vertical ? SnapReference.BottomWire : SnapReference.RightWire;
