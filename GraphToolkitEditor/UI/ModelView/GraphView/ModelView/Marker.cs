...
namespace Unity.GraphToolkit.Editor
{
    ...
    /// </summary>
    [UnityRestricted]
    internal abstract class Marker : GraphElement
    {
        ...
        public static readonly int k_DefaultDistanceValue = 6;
        ...
        protected VisualElement m_ReferenceElement;

        protected Attacher Attacher { get; private set; }
        protected internal SpriteAlignment Alignment { get; private set; }
