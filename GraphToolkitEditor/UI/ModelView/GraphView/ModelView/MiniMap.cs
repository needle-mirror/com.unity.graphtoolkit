...
namespace Unity.GraphToolkit.Editor
{
    ...
    /// </summary>
    [UnityRestricted]
    internal class MiniMap : ModelView
    {
        /// <summary>
        /// The USS class name added to the <see cref="MiniMap"/>.
        /// </summary>
        ...
        public override void UpdateUIFromModel(UpdateFromModelVisitor visitor)
        {
            ...
            if (! m_UpdateRequested)
            {
                ...
                // Ask for a repaint to trigger OnGenerateVisualContent(), but wait for the GraphView layout to be done.
                schedule.Execute(Update).ExecuteLater(1);
            }
        }
        ...
        void CalculateRects()
        {
            ...
            var containerInvTransform = container.GetWorldTransformInverse();
