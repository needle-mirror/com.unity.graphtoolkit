...
{
    [UnityRestricted]
    internal class ContextCategoryPart : GraphElementPart
    {
        /// <summary>
        ...
        public ContextCategoryPart(string name, ContextNodeModel model, ChildView ownerElement, string parentClassName, bool topCategory)
