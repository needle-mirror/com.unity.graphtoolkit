...
namespace Unity.GraphToolkit.Editor
{
    ...
    /// </summary>
    [UnityRestricted]
    internal class FourWayResizerPart : BaseModelViewPart
    {
        /// <summary>
        ...
        public static FourWayResizerPart Create(string name, Model model, ChildView ownerElement, string parentClassName)
        {
        ...
        /// <param name="ownerElement">The owner of the part.</param>
        /// <param name="parentClassName">The class name of the parent.</param>
        protected FourWayResizerPart(string name, Model model, ChildView ownerElement, string parentClassName)
