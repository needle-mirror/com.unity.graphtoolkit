...
namespace Unity.GraphToolkit.Editor
{
    ...
    [UnityRestricted]
    internal class PortContainerPart : HorizontalPortContainerPart
    {
        ...
        /// <inheritdoc cref="HorizontalPortContainerPart(string, Model, ChildView, string, Func{PortModel, bool})"/>
    ...
    /// </summary>
    [UnityRestricted]
    internal class HorizontalPortContainerPart : BasePortContainerPart
    {
        ...
        public static HorizontalPortContainerPart Create(string name, Model model, ChildView ownerElement,
        ...
        /// <param name="parentClassName">The class name of the parent.</param>
        /// <param name="portFilter">A filter used to select the ports to display in the container.</param>
        protected HorizontalPortContainerPart(string name, Model model, ChildView ownerElement, string parentClassName, Func<PortModel, bool> portFilter)
