...
namespace Unity.GraphToolkit.Editor
{
    ...
    /// </summary>
    [UnityRestricted]
    internal class DynamicBorder : VisualElement
    {
        ...
        /// <summary>
        /// The <see cref="GraphView"/> in which the the border is displayed.
        /// </summary>
        ...
        /// </summary>
        public float HoverWidth { get; protected set; } = 1;

        /// <summary>
        /// The zoom threshold at which the selection width change.
        /// </summary>
        public float SmallWidthThreshold { get; protected set; } = 0.5f;

        /// <summary>
        /// The zoom threshold at which the corners are no longer rounded.
        /// </summary>
        public float CornersThreshold { get; protected set; } = 0.33f;

        /// <summary>
        /// The color of the outline when the <see cref="GraphElement"/> is selected.
        /// </summary>
        public Color SelectionColor { get; protected set; } = DefaultSelectionColor;

        /// <summary>
        /// The color of the outline when the <see cref="GraphElement"/> is only hovered.
        /// </summary>
        public Color HoverOnlyColor { get; protected set; } = DefaultHoverOnlyColor;

        /// <summary>
        /// The color of the outline when the <see cref="GraphElement"/> is highlighted.
        /// </summary>
        public Color HighlightColor { get; protected set; } = DefaultHighlightColor;
        ...
        public DynamicBorder(ModelView view)
        {
            ...
            GraphView = view.RootView as GraphView;
        ...
        protected void OnLeave(MouseLeaveEvent e)
        {
            m_Hover = false;
            MarkDirtyRepaint();
        }
