...
namespace Unity.GraphToolkit.Editor
{
    ...
    [Serializable]
    [UnityRestricted]
    internal class BlackboardViewStateComponent : PersistedStateComponent<BlackboardViewStateComponent.StateUpdater>
    {
        /// <summary>
        /// The updater for the <see cref="BlackboardViewStateComponent"/>.
        /// </summary>
        [UnityRestricted]
        internal class StateUpdater : BaseUpdater<BlackboardViewStateComponent>
        {
            /// <summary>
            ...
            public void SetVariableDeclarationModelExpanded(VariableDeclarationModelBase model, bool expanded)
            {
            ...
            public void SetGroupModelExpanded(GroupModelBase model, bool expanded)
            {
...
#pragma warning restore CS0618
        ...
        public bool GetVariableDeclarationModelExpanded(VariableDeclarationModelBase model)
        {
        ...
        /// <param name="model">The variable declaration model.</param>
        /// <returns>True is the UI for the model should be expanded. False otherwise.</returns>
        public bool GetGroupExpanded(GroupModelBase model)
        {
