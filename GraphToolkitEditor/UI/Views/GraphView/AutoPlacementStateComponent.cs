...
namespace Unity.GraphToolkit.Editor
{
    ...
    /// </summary>
    [UnityRestricted]
    internal class AutoPlacementStateComponent : StateComponent<AutoPlacementStateComponent.StateUpdater>
    {
        /// <summary>
        /// Updater for <see cref="AutoPlacementStateComponent"/>.
        /// </summary>
        [UnityRestricted]
        internal class StateUpdater : BaseUpdater<AutoPlacementStateComponent>
        {
            /// <summary>
            ...
            public void MarkModelToRepositionAtCreation((GraphElementModel, WireModel, WireSide) model, Changeset.RepositionType repositionType, List<GraphElementModel> modelsToHideDuringAutoPlacement = null)
            {
                m_State.CurrentChangeset.AddModelToRepositionAtCreation(model, repositionType);
        ...
        {
            /// <summary>
            /// The type of reposition work.
            /// </summary>
            [Serializable]
            [UnityRestricted]
            internal enum RepositionType
            {
                FromWire,
                FromPort
            }
            ...
            [Serializable]
            [UnityRestricted]
            internal struct ModelToReposition
            {
                [SerializeField]
                Hash128 m_Model;
                [SerializeField]
                ...
                WireSide m_Side;
                [SerializeField]
                RepositionType m_RepositionType;
                ...
                {
                    get => m_RepositionType;
                    set => m_RepositionType = value;
                }
            }
