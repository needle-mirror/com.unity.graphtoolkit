...
namespace Unity.GraphToolkit.Editor
{
    ...
    /// </summary>
    [UnityRestricted]
    internal class SpacePartitioningStateComponent : StateComponent<SpacePartitioningStateComponent.StateUpdater>
    {
        /// <summary>
        /// Updater for the <see cref="SpacePartitioningStateComponent"/>
        /// </summary>
        [UnityRestricted]
        internal class StateUpdater : BaseUpdater<SpacePartitioningStateComponent>
        {
            /// <summary>
